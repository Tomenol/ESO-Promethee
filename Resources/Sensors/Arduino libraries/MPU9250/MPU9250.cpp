...
*/
float* MPU9250::getRawAccelerationVector()
{
  ...
  // ajouter détection de seuil automatique
  // modification de l'échelle de mesure automatique
...
*/
float* MPU9250::getRawAngularVelocityVector()
{
  Wire.beginTransmission(this->dev_address);
